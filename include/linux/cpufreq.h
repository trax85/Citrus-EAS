...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ENDURANCE)
extern struct cpufreq_governor cpufreq_gov_endurance;
#define CPUFREQ_DEFAULT_GOVERNOR       (&cpufreq_gov_endurance)
#endif
